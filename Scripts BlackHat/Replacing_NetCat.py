...
if __name__ == '__main__':
  parser = argparse.ArgumentParser( description='BHP Net Tool', formatter_class=argparse.RawDescriptionHelpFormatter, epilog=textwrap.dedent('''Example: netcat.py -t 192.168.1.108 -p 5555 -l -c #
  command shell
  ...
  if self.args.execute:
    ...
    while True:
      ...
      if data:
        ...
        break
    with open(self.args.upload, 'wb') as f: f.write(file_buffer)
